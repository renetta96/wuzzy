...
local states = {
    ...
    State {
        ...
        ontimeout = function(inst)
            inst.sg:GoToState(
                inst.components.combat ~= nil and not inst.components.combat:HasTarget() and
    ...
    State {
        ...
        onenter = function(inst, start_anim)
            inst.Physics:Stop()
            local animname =
                (inst.components.combat ~= nil and inst.components.combat:HasTarget() or inst:HasTag("killer")) and
                "idle_angry" or
                "idle"
            if start_anim then
