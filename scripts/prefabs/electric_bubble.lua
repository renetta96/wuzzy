...
return Prefab("electric_bubble", fn, assets), Prefab("electric_bubble_hit", hit_fn), Prefab(
  "charge_fx",
  charge_fx,
  assets
), Prefab("electric_wisp", wisp, assets), Prefab("electric_wisp_launch", wisp_launch, assets)
