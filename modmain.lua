...
TUNING.ZETA_SUMMON_CHANCE_TYRANT = 0.25
TUNING.ZETA_SUMMON_CHANCE_SHEPHERD = 0.75
TUNING.ZETA_SUMMON_CHANCE = 0.5
...
TUNING.MUTANT_BEEHIVE_REGEN_COST_A = 0.15
TUNING.MUTANT_BEEHIVE_REGEN_COST_S = 1.5
TUNING.MUTANT_BEEHIVE_REGEN_COST_B = 1.7

TUNING.MUTANT_BEEHIVE_MAINTAIN_COST_A = 0.15
TUNING.MUTANT_BEEHIVE_MAINTAIN_COST_S = 1.5
TUNING.MUTANT_BEEHIVE_MAINTAIN_COST_B = 1.08
...
local function performSwap(doer, target, invobject)
  if target ~= nil and target:IsValid() and doer ~= nil and doer:IsValid() and invobject ~= nil then
