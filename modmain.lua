...
TUNING.ATEZAROTH_MAX_SANITY = 125
TUNING.ATEZAROTH_MAX_HUNGER = 200
TUNING.ATEZAROTH_BLOODLUST_THRESHOLD_1 = 0.25
TUNING.ATEZAROTH_BLOODLUST_THRESHOLD_2 = 0.5
TUNING.ATEZAROTH_MAX_TOUGHNESS = 0.6
TUNING.ATEZAROTH_DEFAULT_DAMAGE_MULTIPLIER = 0.7
